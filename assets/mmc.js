            ...
            if ( data.status == 200 ) {
                ...
                $.each( data, function ( i, v ) {
                    ...
                    var newsitem =
                        ...
                        randtag +
                        '</label></figure></a><h4 class="margin-top-20 size-14 weight-700 uppercase height-50" style="overflow:hidden;"><a href="' +
                        v.link + '">' + title +
                        '</a></h4><p class="text-justify height-100" style="overflow:hidden;">' +
                        excerpt +
