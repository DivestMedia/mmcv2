...
?>
	<section>
		...
		<blockquote class="quote">
			<p> We’re not here to dazzle with science, we’re here to help; we’re different from the rest and we make no apologies for it.</p>
			<cite>Web Anonymouse</cite>
		</blockquote>
			<div class="row">
				...
				<div class="col-md-9 col-sm-9">
					...
					<p>This is a website aimed at both the discerning expert investor who needs to keep abreast of current events, market movements and new investment opportunities, 
and also the ambitious novice individual who needs some simple financial advice and a guiding light to point the way and simplify the process,
 thus allowing everyone to gain an advantage in the weird and wonderful world of investment and personal wealth accumulation. 
</p>
...
<p>What else does anybody really want from life? Health and wealth, in that order, with the latter acting as a guarantor for the former; we can’t get this by wishing it to come to us, we can only get it by going after it. After all, it’s true that you can’t get everything in life, but you can still give it a good go. This site’s purpose is to lend a helping hand to the valiant few in search of financial advice and investment opportunities who’ve made the right choice of joining the investment magic circle.</p>

<blockquote class="pull-right">
	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
	<cite>Albert Einstein</cite>
</blockquote>
<p>This is a website aimed at the successful businessman or smart entrepreneur who are looking to further increase their wealth and ensure that their riches have a chance to grow exponentially, thus guaranteeing that bright and stable future we all want. It’s aimed at the individual investor who is determined to increase their personal wealth and not let the grass grow under their feet. It’s aimed at those who are shrewd enough to recognize that riches don’t come to you, and who are brave enough to go after what they want. It’s aimed at novice investors who just need some information and basic investment advice. It’s aimed at all of us out there who get intimidated by complicated investor sites seemingly designed to be daunting. It’s aimed at ordinary successful business people who have decided to not be overawed or fazed any longer. It’s aimed at all of us.</p>
<p>We also provide a forum whereby leading experts from different fields of investment can have a platform, by way of featured articles, from which to offer guidance and financial advice, and where beginner investors can find the right financial advisor to help them prosper. We offer unbiased investment advice and conflict-free counsel from experienced analysts with long-term successful track records, and we present it in a user-friendly and concise format so that it actually does what it’s supposed to do; help you. We will also strive to present you with new and exciting investment opportunities whenever we can. And we’re also going to review and assess other sites, forums and financial aids, and we’re going to tell the truth.</p>
				</div>
			</div>
		</div>
	</section>
