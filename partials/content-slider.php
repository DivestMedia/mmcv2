	...
	?>
		...
		<div class="ms-slide">
			...
			<h2 class="ms-layer font-proxima ms-promo-travel-place hidden-3xs cont-slider-title" style="left: 15px; top: 210px;" data-type="text" data-delay="10" data-effect="skewright(50,340)" data-ease="easeOutExpo" data-duration="2200">
			...
			<div class="ms-layer ms-promo-travel-description" style="left: 15px; top: 310px;" data-type="text" data-delay="30" data-effect="rotate3dbottom(100,0,0,70)" data-ease="easeOutExpo" data-duration="2300">
				...
				<p class="nopadding"><a href="<?=$_banner->link?>" class="btn btn-lg btn-primary noradius"><?=$btn_text?></a></p>
			</div>
