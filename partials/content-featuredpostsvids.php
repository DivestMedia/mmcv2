									...
									<div class="col-sm-4 margin-bottom-20">
										<?php if(strlen($post->post_content) > 20){ ?>
											<div class="box-flip box-icon box-icon-center box-icon-round box-icon-large text-center">
												...
												<div class="back" style="max-height:147px!important;">
													<div class="box2" style="max-height:147px!important;height:147px!important;margin-top:10px!important;border-radius:0!important;">
