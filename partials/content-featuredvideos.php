...
foreach ($featuredvids as $videohere) {
    ...
    if($videohere){
        ...
        if($video_cats){
            $hascat = true;
            if(count($video_cats)){
                $videocat = $$video_catsvidcat->name;
                        ...
                        <figure>
                            ...
                            <span class="item-description">
                                ...
                                <span class="inner margin-top-30">
                                    <h3>
                                        <?php if(is_home()): ?>
                                            <small><a href="#" class="text-white">Bruce Curran</a></small>
                                        <?php endif; ?>

                                        <em><a href="<?=($video['titlelink'])?>" class="text-white"><?=$video['title']?></a></em><?=$video['description']?></h3>
